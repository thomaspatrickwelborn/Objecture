...
function getModelProperty($model, $options, $path) {
  const { target, path } = $model;
  // Arguments
...
function setModel($model, $options, $properties) {
  iterateProperties: 
...
function setModelProperty($model, $options, $path, $value) {
  const { target, path, schema } = $model;
...
function deleteModel($model, $options) {
  const { target } = $model;
...
function deleteModelProperty($model, $options, $path) {
  const { target, path, schema } = $model;
